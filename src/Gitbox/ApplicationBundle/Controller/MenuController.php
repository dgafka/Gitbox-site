...
use Gitbox\ApplicationBundle\Entity\Menu;
use Gitbox\ApplicationBundle\Form\MenuType;
...
class MenuController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('GitboxApplicationBundle:Menu')->findAll();
     ...
     * @Method("POST")
     * @Template("GitboxApplicationBundle:Menu:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('GitboxApplicationBundle:Menu')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("GitboxApplicationBundle:Menu:edit.html.twig")
     */
