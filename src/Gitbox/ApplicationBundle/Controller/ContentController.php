...
use Gitbox\ApplicationBundle\Entity\Content;
use Gitbox\ApplicationBundle\Form\ContentType;
...
class ContentController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('GitboxApplicationBundle:Content')->findAll();
     ...
     * @Method("POST")
     * @Template("GitboxApplicationBundle:Content:new.html.twig")
     */
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('GitboxApplicationBundle:Content')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("GitboxApplicationBundle:Content:edit.html.twig")
     */
