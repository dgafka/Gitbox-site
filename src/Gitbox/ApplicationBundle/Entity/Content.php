...
class Content
{
    ...
    /**
     * @var \Gitbox\ApplicationBundle\Entity\Category
     *
     * @ORM\ManyToOne(targetEntity="Gitbox\ApplicationBundle\Entity\Category")
     * @ORM\JoinColumns({
    ...
    /**
     * @var \Gitbox\ApplicationBundle\Entity\Menu
     *
     * @ORM\ManyToOne(targetEntity="Gitbox\ApplicationBundle\Entity\Menu")
     * @ORM\JoinColumns({
     ...
     * Set idCategory
     *
     * @param \Gitbox\ApplicationBundle\Entity\Category $idCategory
     * @return Content
     */
    public function setIdCategory(\Gitbox\ApplicationBundle\Entity\Category $idCategory = null)
    {
     ...
     * Get idCategory
     *
     * @return \Gitbox\ApplicationBundle\Entity\Category 
     */
     ...
     * Set idMenu
     *
     * @param \Gitbox\ApplicationBundle\Entity\Menu $idMenu
     * @return Content
     */
    public function setIdMenu(\Gitbox\ApplicationBundle\Entity\Menu $idMenu = null)
    {
        $this->idMenu = $idMenu;
     ...
     * Get idMenu
     *
     * @return \Gitbox\ApplicationBundle\Entity\Menu 
     */
