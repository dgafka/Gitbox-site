...
class Menu
{
    ...
    /**
     * @var \Gitbox\ApplicationBundle\Entity\Module
     *
     * @ORM\ManyToOne(targetEntity="Gitbox\ApplicationBundle\Entity\Module")
     * @ORM\JoinColumns({
     ...
     * @return Menu
     */
    public function setIdModule(\Gitbox\ApplicationBundle\Entity\Module $idModule = null)
    {
     ...
     * Get idModule
     *
     * @return \Gitbox\ApplicationBundle\Entity\Module 
     */
